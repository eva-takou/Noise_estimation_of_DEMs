...
#Taken from: https://github.com/seokhyung-lee/color-code-stim/blob/main/color_code_stim.py
#All credit is to the authors of the original code.
#This is just copied here because their github versions are changing and newer versions were not compatible with our code.
...
class ColorCode:
    ...
    def decompose_detector_error_model(
        ...
        # Original DEM
        # print("dem before flatten:",self.circuit.detector_error_model())
        ...
        # print("dem after flatten:",org_dem)
        ...
        # print("det_ids_to_reduce:",det_ids_to_reduce)
        # print("num_detectors",num_detectors)
            ...
            if remove_non_edge_like_errors:
                ...
                if dem1_dets:
                    if len(dem1_dets) >= 3 or len(dem2_dets) >= 2:
                        print("Ignoring dem1_dets:",dem1_dets,"or dem2_dets:",dem2_dets)
                        continue
                else:
                    if len(dem2_dets) >= 3:
                        print("Ignoring dem2_dets:",dem2_dets)
                        continue
            
            # print("dem2 dets originally:",dem2_dets)

            # print("dem1 virtual obs dict:",dem1_virtual_obs_dict)
            if dem1_det_ids:
                ...
                try:
                    ...
                    # print("virtual obs not in keyerror:",virtual_obs)

                except KeyError:

                    virtual_obs = len(dem1_probs_dict)
                    # print("virtual obs in keyerror:",virtual_obs)
                    dem1_obss.append(
        ...
        return dem1, dem2 #pauli_decomposed_targets_dict,pauli_decomposed_probs_dict, 
    ...
    def sample(self, shots, seed=None):
        ...
        # print("shape of det:",np.shape(det))
